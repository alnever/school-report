...
$rep_info = $tab->get_reports_by_user(array("id_report" => $id_report))[0];
?>
  ...
  <tr>
    ...
    <td width="70%">
      <?php
        ...
        echo $tab->get_ext_item($rep_info["id_teacher"])["teacher_combo_name"];
       ?>
    </td>
  </tr>
  <tr>
...
<?php
  ...
  $absents = $tab->get_list(array("id_report" => $id_report))[0];
?>
...
<p>
  <strong>
    ...
    <?php echo $total_lacks[0]["total_lack"]; ?>
</p>
...
<!-- good -->
<?php
  $goods = $tab->get_good_by_report(array("id_report" => $id_report), "student_combo_name");
  $good_count = $tab->count_good_by_report(array("id_report" => $id_report));
?>
