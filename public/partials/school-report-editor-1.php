...
<div id="good_students_panel" class="easyui-panel"
  ...
  <h3>Общее количество отличников и хорошистов</h3>
  <form id="total_good_form" method="post">
    <div>
      <label for="good_total"><font color="#AA0000">Вводится ОБЩЕЕ число и отличников, и хорошистов:</font></label>
      <input id="good_total" name="good_total" class="easyui-numberbox" data-options="required:true,min:0,precision:0,value:0" style="width:100%" />
    </div>
    <input type="hidden" id="action_7" name="action" value="edit_total_good" />
    <input type="hidden" id="id_report_7" name="id_report" value="0" />
    <input type="hidden" id="id_good_total" name="id_good_total" value="0" />
    <input type="submit" class="easyui-submit" value="Сохранить" />
  </form>
